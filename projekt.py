...
plt.legend()
plt.show()
#plt.savefig('C:\Kuba\mkws\CJU_phi_p1var.png')
...
plt.legend()
plt.show()
#plt.savefig('C:\Kuba\mkws\CJU_phi_T1var.png')
...
plt.legend()
plt.show()
#plt.savefig('C:\Kuba\mkws\CJU_p1_T1var.png')
...
plt.legend()
plt.show()
#plt.savefig('C:\Kuba\mkws\CJU_p1_phivar.png')
...
plt.legend()
plt.show()
#plt.savefig('C:\Kuba\mkws\CJU_T1_p1var.png')
...
plt.legend()
plt.show()
#plt.savefig('C:\Kuba\mkws\CJU_T1_phivar.png')   